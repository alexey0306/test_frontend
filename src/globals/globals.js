...
export const TMPL_FILE_ATTACH = "<table class=\"table table-bordered attached\"><tbody><tr><td><span style='margin-left:10px'><img src='/images/%s'></span><span style='margin-left:10px'><a href='%sstatic/%s'>%s</a></span><span id='enml'><en-media data-type='%s' data-hash='%s' data-filename='%s'/></span></td></tr></tbody></table><p><br></p>";
